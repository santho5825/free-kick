...
function call_goal_score(val){
    if(!s_oMain.goalScore){
        s_oMain.goalScore = val;
        // s_oMain.gameExit();
        setTimeout(function() {
...
function CGame(e, status) {
    ...
    (this._init = function () {
        ...
        $(s_oMain).trigger("start_session"),
            ...
            defender = 'defender-single';
            defenderRight = 'defender-single';

            if(ROUNDS_NUM == 4){
                defenderRight = 'defender-single';
                
            } else if(ROUNDS_NUM == 5){
                defender = 'level4';  
                defenderRight = 'defender-single';
            ...
            (oddPoint[0].x = 435),
                (oddPoint[0].y = 131),
            s.addChild(oddPoint[0]), 
            (oddPoint[1] = new createjs.Text("3", "15px " + FONT_GAME, TEXT_COLOR)),
            (oddPoint[1].textAlign = "center"),
            (oddPoint[1].y = 80),
            s.addChild(oddPoint[1]), 
            (oddPoint[2] = createBitmap(s_oSpriteLibrary.getSprite("odds-blue-left")),undefined, undefined, 300, 80),
            (oddPoint[2].x = 385),
            (oddPoint[2].y = 129),
            s.addChild(oddPoint[2]),  
            
            (oddPoint[3] = createBitmap(s_oSpriteLibrary.getSprite("odds-blue-right")),undefined, undefined, 600, 80),
            (oddPoint[3].x = 940),
                (oddPoint[3].y = 129),
            s.addChild(oddPoint[3]), 
            (oddPoint[4] = createBitmap(s_oSpriteLibrary.getSprite("odd_top_blue")),undefined, undefined, 300, 80),
            (oddPoint[4].x = 435),
                (oddPoint[4].y = 50),
            s.addChild(oddPoint[4]),
            (oddPoint[5] = createBitmap(s_oSpriteLibrary.getSprite("odd_left_red")),undefined, undefined, 230, 1),
            (oddPoint[5].x = 385),
            (oddPoint[5].y = 50),
            s.addChild(oddPoint[5]),
            (oddPoint[6] = createBitmap(s_oSpriteLibrary.getSprite("odd_right_red")),undefined, undefined, 940, 1),
            (oddPoint[6].x = 940),
                (oddPoint[6].y = 50),
            s.addChild(oddPoint[6]), 
           
        (S = new CGoalKeeper(CANVAS_WIDTH_HALF - 100, CANVAS_HEIGHT_HALF - 250, s)), T.push(S),
        ...
        (this.onPressUp = function () {
            ...
            var isTriggered = JSON.parse(sessionStorage.getItem('isTriggered')) || true;

            if(s_oMain.goalScore == 0)
                $(s_oMain).trigger("ball_swipe");
            if (!y && (r && l && r.x != l.x && r.y != l.y) && !s_oMain.goalScore) { // && isTriggered
                ...
                {point:4,
                   ...
                   {"point":6,"r":{"x":713.2946554149086,"y":457.2795216741405},"l":{"x":510.0583684950773,"y":100.20926756352765} , color: 'W', pos: 'MIDDLE'},
                   {"point":7,"r":{"x":713.2946554149086,"y":457.2795216741405},"l":{"x":516.0583684950773,"y":260.20926756352765} , color: 'W', pos: 'LEFT'},
                    {"point":8,"r":{"x":713.2946554149086,"y":457.2795216741405},"l":{"x":913.0583684950773,"y":260.20926756352765} , color: 'W', pos: 'RIGHT'}, 
            ...
            // if (s_bMobile) {
            //     arr[8] = {"point":8,"r":{"x":674.1666666666666,"y":446.7563527653213},"l":{"x":913.0583684950773,"y":260.20926756352765} , color: 'W', pos: 'RIGHT'};
            //     // 0.9439775910364147
            // }
            ...
            if(indexVal > -1){
                ...
                if(ROUNDS_NUM >= 2){
                    ...
                    //     .to({x: ROUNDS_NUM == 4 ? 880 : 900}, 900, createjs.Ease.getPowInOut(4))
                ...
                if(GUARD_HIT){
                    ...
                    if(pos == 'MIDDLE'){
                        createjs.Tween.get(def, {loop: false})
                          .to({x:CANVAS_WIDTH_HALF-150, y: 40 }, 900, createjs.Ease.getPowInOut(15))
                        .to({alpha: 0, y: 40}, 500, createjs.Ease.getPowInOut(2))

                    }

                    if(pos == 'LEFT' && ROUNDS_NUM == 3){
                        createjs.Tween.get(def, {loop: false})
                        .to({x: 380}, 900, createjs.Ease.getPowInOut(4))
                        
                        createjs.Ticker.setFPS(60);
                    } else if(pos == 'RIGHT'&& ROUNDS_NUM == 3){
                        createjs.Tween.get(def, {loop: false})
                        .to({x: 910}, 870, createjs.Ease.getPowInOut(10));
                        createjs.Ticker.setFPS(60);
                    }
            //             createjs.Tween.get(def, {loop: false})
            ...
            //         } else if(pos == 'RIGHT'){
            //             createjs.Tween.get(def, {loop: false})
            //   .to({x:880 }, 900, createjs.Ease.getPowInOut(4))
    ...
    let rVal =  arr[indexVal].r;
    let lVal =  arr[indexVal].l;
    if(s_bMobile){
        let roundOffX = offsetX;
        let roundOffY = offsetY;
        rVal.x *= roundOffX;
        rVal.y *= roundOffY;
        lVal.x *= roundOffX;
        lVal.y *= roundOffY;
    ...
    // }
            ...
            rollReset = true;
                ...
                if (n > HIT_BALL_MIN_FORCE) {
                    ...
                    var i = P / 10;
                    i > MAX_FORCE_Y ? (i = MAX_FORCE_Y) : MIN_FORCE_Y > i && (i = MIN_FORCE_Y),
                     A.set(-t.getX() * FORCE_MULTIPLIER_AXIS.x, i, t.getY() * FORCE_MULTIPLIER_AXIS.z), 
                ...
                sessionStorage.setItem('isTriggered', JSON.stringify(false))
        ...
        (this.trigger_goal_score = function(){
            ...
            if(GK_HIT && !GUARD_HIT && ROUNDS_NUM > 1){
                scoreValue = GK_ODD;
            } else if(!GK_HIT && (GUARD_HIT && ROUNDS_NUM > 2) ){
                scoreValue = 0.5;
            }
        ...
        (this.restartLevel = function () {
            this.resetValues(), this.resetScene(), (G = STATE_PLAY), this.startOpponentShot && this.startOpponentShot(), $(s_oMain).trigger("restart_level", M);
        }),
        (this.resetDefenderPosition = function(){
            if(def){
                def.x = 380;
            }
        }),
        ...
        (this.endTurn = function () {
            ...
            this.restartLevel();
            I < NUM_OF_PENALTY
                ? (I++, t.refreshLaunchBoard(I, NUM_OF_PENALTY), this.resetScene(true), (y = !1), (m = MS_TIME_SWIPE_START))
        ...
        (this.ballOut = function () {
            ...
            // if(w = !0){
                ...
                ((w = !0))){
                    ...
                    // // // // console.log('dfsdf');
                    // t.createAnimText(TEXT_BALL_OUT, 90, !1, TEXT_COLOR_1, TEXT_COLOR_STROKE), 
                    playSound("ball_saved", 1, 0), (g = 1), (H = 0);
                    // alert('else')
        ...
        (this.resetPoleCollision = function () {
            ...
            /* t.createAnimText(TEXT_BALL_OUT, 80, !1, TEXT_COLOR_1, TEXT_COLOR_STROKE), */
            f > 0 ? (f -= s_iTimeElaps) : (b && L) || ( (g = 1), (H = 0), playSound("ball_saved", 1, 0), this.endTurn(), (f = TIME_POLE_COLLISION_RESET));
        }),
        ...
        (this._updatePlay = function () {
            for (var e = 0; PHYSICS_ACCURACY > e; e++) i.update();console.log( b || w || L, '>>updateplay<<', b, w, L, 'rolls:',rollReset)
...
function CToggle(e, t, n, i, o) {
    ...
    (this._init = function (e, t, n, i, o) {
        ...
        var d = { images: [n], frames: { width: n.width, height: n.height, regX: n.width / 2 / 2, regY: n.height / 2 }, animations: { state_true: [0], state_false: [1] } },
...
function CSpriteLibrary() {
    ...
    (this.init = function (s, r, l) {
        ...
        (this.addSprite = function (n, i) {
            if(n == 'defender'){
                ((e[n] = { szPath: i, oSprite: new Image() }), t++);
            } else{
...
function CInterface(status) {
    ...
    return (
        (this._init = function () {
            ...
            let width = parseFloat(canvasEle.style.width);
            ...
            // if (((n = { x: t.x - c.height - 10, y: t.y }), (s = new CGfxButton(n.x, n.y, c)), s.addEventListener(ON_MOUSE_UP, this.onButPauseRelease, this), DISABLE_SOUND_MOBILE === !1 || s_bMobile === !1)) {
            //     var c = s_oSpriteLibrary.getSprite("audio_icon");
            //     (e = { x: n.x - c.height - 10, y: t.y }), (l = new CToggle(e.x, e.y, c, s_bAudioActive)), l.addEventListener(ON_MOUSE_UP, this._onAudioToggle, this);
            // }
        ...
        (this.unload = function () {
            a.unload(), (a = null), (DISABLE_SOUND_MOBILE !== !1 && s_bMobile !== !1) || (l && l.unload(), (l = null)), E && !inIframe() && (r.unload(), (r = null)), (s_oInterface = null);
        }),
    ...
    return (
        (this._init = function () {
            (i = new createjs.Container()),
                ...
                // point text
                (textPoint[0] = new createjs.Text(AREAS_INFO[1].value, "20px " + FONT_GAME, TEXT_COLOR)),
                (textPoint[0].x = CANVAS_WIDTH / 2),
                (textPoint[0].y = 80),
                (textPoint[0].textAlign = "center"),
                i.addChild(textPoint[0]);

                (textPoint[1] = new createjs.Text(AREAS_INFO[4].value, "20px " + FONT_GAME, TEXT_COLOR)),
                (textPoint[1].x = CANVAS_WIDTH / 2),
                (textPoint[1].y = 200),
                (textPoint[1].textAlign = "center"),
                i.addChild(textPoint[1]);

                (textPoint[2] = new createjs.Text(AREAS_INFO[0].value, "20px " + FONT_GAME, TEXT_COLOR)),
                (textPoint[2].x = 410),
                (textPoint[2].y = 70),
                (textPoint[2].textAlign = "center"),
                i.addChild(textPoint[2]);

                (textPoint[3] = new createjs.Text(AREAS_INFO[2].value, "20px " + FONT_GAME, TEXT_COLOR)),
                (textPoint[3].x = 965),
                (textPoint[3].y = 70),
                (textPoint[3].textAlign = "center"),
                i.addChild(textPoint[3]);

                (textPoint[4] = new createjs.Text(AREAS_INFO[5].value, "20px " + FONT_GAME, TEXT_COLOR)),
                (textPoint[4].x = 965),
                (textPoint[4].y = 200),
                (textPoint[4].textAlign = "center"),
                i.addChild(textPoint[4]);

                (textPoint[5] = new createjs.Text(AREAS_INFO[3].value, "20px " + FONT_GAME, TEXT_COLOR)),
                (textPoint[5].x = 410),
                (textPoint[5].y = 200),
    ...
    return (
        ...
        (this.rolls = function () {
            ...
            r.angularVelocity.x < 0 && (i = this._goToNextFrame),
                ...
                // if(GUARD_HIT || GK_HIT){
                    if(rollReset)
                    console.log(e ,t , n, rollReset, '>reset<');
                    if(e < 0 && t < 0.5 && n < 1 && rollReset){
                        ...
                        // setTimeout(()=>{
                            ...
                            sessionStorage.setItem('isTriggered', JSON.stringify(true))
                        // }, 2000)
...
function CMain(e) {
    ...
    this.goalScore = e.goalScore;
        ...
        (this.soundLoaded = function () {
            ...
            i.refreshLoader(e), r === l && (i.unload(), this.gotoMenu(true));/*  (DISABLE_SOUND_MOBILE !== !1 && s_bMobile !== !1) || (s_oSoundTrack = createjs.Sound.play("soundtrack", { loop: -1 })), */
        }),
            ...
            createjs.Sound.initializeDefaultPlugins() &&
                (navigator.userAgent.indexOf("Opera") > 0 || navigator.userAgent.indexOf("OPR") > 0
                    ? ((createjs.Sound.alternateExtensions = ["mp3"]),
                      ...
                      createjs.Sound.registerSound("./assets/football/sounds/click.ogg", "click"),
                      createjs.Sound.registerSound("./assets/football/sounds/drop_bounce_grass.ogg", "drop_bounce_grass"),
                      createjs.Sound.registerSound("./assets/football/sounds/soundtrack.ogg", "soundtrack"),
                      createjs.Sound.registerSound("./assets/football/sounds/goal.ogg", "goal"),
                      createjs.Sound.registerSound("./assets/football/sounds/ball_saved.ogg", "ball_saved"),
                      createjs.Sound.registerSound("./assets/football/sounds/kick.ogg", "kick"),
                      createjs.Sound.registerSound("./assets/football/sounds/pole.ogg", "pole"))
                    : ((createjs.Sound.alternateExtensions = ["ogg"]),
                      createjs.Sound.addEventListener("fileload", createjs.proxy(this.soundLoaded, this)),
                      createjs.Sound.registerSound("./assets/football/sounds/click.mp3", "click"),
                      createjs.Sound.registerSound("./assets/football/sounds/drop_bounce_grass.mp3", "drop_bounce_grass"),
                      createjs.Sound.registerSound("./assets/football/sounds/soundtrack.mp3", "soundtrack"),
                      createjs.Sound.registerSound("./assets/football/sounds/goal.mp3", "goal"),
                      createjs.Sound.registerSound("./assets/football/sounds/ball_saved.mp3", "ball_saved"),
                      createjs.Sound.registerSound("./assets/football/sounds/kick.mp3", "kick"),
                      createjs.Sound.registerSound("./assets/football/sounds/pole.mp3", "pole")),
                (l += 7));
        }),
        (this._loadImages = function () {
            const urlParams = new URLSearchParams(window.location.search);
            var roundsNum = urlParams.get('status') || false;
            var defender = 'defender-left';
            var defenderRight = '';
            // if(roundsNum == 4){
            //   defenderRight = 'defender-right';
            ...
            s_oSpriteLibrary.init(this._onImagesLoaded, this._onAllImagesLoaded, this),
                s_oSpriteLibrary.addSprite("but_play", "./assets/football/sprites/but_play.png"),
                s_oSpriteLibrary.addSprite("but_exit", "./assets/football/image/close-icon.svg"),
                s_oSpriteLibrary.addSprite("bg_menu", "./assets/football/image/bg_menu.jpg"),
                s_oSpriteLibrary.addSprite("bg_game", "./assets/football/image/bg_game.jpg"),
                s_oSpriteLibrary.addSprite("odd_middle_green", "./assets/football/image/points/green-point.png"),
                s_oSpriteLibrary.addSprite("but_info", "./assets/football/image/info-icon.svg"),
                s_oSpriteLibrary.addSprite("but_odd_point", "./assets/football/image/show-odds-icon.svg"),
                // s_oSpriteLibrary.addSprite("defender", "./assets/football/image/"+defender+".png"),
                s_oSpriteLibrary.addSprite("odds-blue-right", "./assets/football/image/points/odds-blue-right.png"),
                s_oSpriteLibrary.addSprite("odds-blue-left", "./assets/football/image/points/odds-blue-left.png"),
                s_oSpriteLibrary.addSprite("odd_top_blue", "./assets/football/image/points/odds-blue-top.png"),
                s_oSpriteLibrary.addSprite("odd_left_red", "./assets/football/image/points/odds-red-left.png"),
                s_oSpriteLibrary.addSprite("odd_right_red", "./assets/football/image/points/odds-red-right.png"),
                s_oSpriteLibrary.addSprite("odds-defender", "./assets/football/image/level1/odds-defender@2x.png"),
                s_oSpriteLibrary.addSprite("odds-gk", "./assets/football/image/level1/odds-GK@2x.png"),
                s_oSpriteLibrary.addSprite("odds-defender", "./assets/football/image/level1/odds-defender@2x.png"),
                s_oSpriteLibrary.addSprite("msg_box", "./assets/football/sprites/msg_box.png"),
                s_oSpriteLibrary.addSprite("audio_icon", "assets/football/image/volume-up-solid.svg"),
                s_oSpriteLibrary.addSprite("audio_mute_icon", "assets/football/image/volume-mute-icon.svg"),
                s_oSpriteLibrary.addSprite("but_home", "./assets/football/sprites/but_home.png"),
                s_oSpriteLibrary.addSprite("but_restart", "./assets/football/sprites/but_restart.png"),
                s_oSpriteLibrary.addSprite("but_fullscreen", "./assets/football/sprites/but_fullscreen.png"),
                s_oSpriteLibrary.addSprite("ball", "./assets/football/sprites/ball.png"),
                s_oSpriteLibrary.addSprite("but_level", "./assets/football/sprites/but_level.png"),
                s_oSpriteLibrary.addSprite("but_continue", "./assets/football/sprites/but_continue.png"),
                s_oSpriteLibrary.addSprite("but_yes", "./assets/football/sprites/but_yes.png"),
                s_oSpriteLibrary.addSprite("but_no", "./assets/football/sprites/but_no.png"),
                s_oSpriteLibrary.addSprite("logo_ctl", "./assets/football/sprites/logo_ctl.png"),
                s_oSpriteLibrary.addSprite("but_pause", "./assets/football/sprites/but_pause.png"),
                s_oSpriteLibrary.addSprite("arrow_right", "./assets/football/sprites/arrow_right.png"),
                s_oSpriteLibrary.addSprite("arrow_left", "./assets/football/sprites/arrow_left.png"),
                s_oSpriteLibrary.addSprite("ball_shadow", "./assets/football/sprites/ball_shadow.png"),
                s_oSpriteLibrary.addSprite("start_ball", "./assets/football/sprites/start_ball.png"),
                s_oSpriteLibrary.addSprite("hand_touch", "./assets/football/sprites/hand_touch.png"),
                s_oSpriteLibrary.addSprite("cursor", "./assets/football/sprites/cursor.png"),
                s_oSpriteLibrary.addSprite("shot_left", "./assets/football/sprites/shot_left.png"),
                s_oSpriteLibrary.addSprite("goal", "./assets/football/image/goal.png");
            for (var e = 0; NUM_SPRITE_PLAYER > e; e++) s_oSpriteLibrary.addSprite("player_" + e, "./assets/football/sprites/player/player_" + e + ".png");
            for (var e = 0; e < NUM_SPRITE_GOALKEEPER[IDLE]; e++) s_oSpriteLibrary.addSprite(SPRITE_NAME_GOALKEEPER[IDLE] + e, "./assets/football/sprites/goalkeeper_idle/gk_idle_" + e + ".png");
            for (var e = 0; e < NUM_SPRITE_GOALKEEPER[RIGHT]; e++) s_oSpriteLibrary.addSprite(SPRITE_NAME_GOALKEEPER[RIGHT] + e, "./assets/football/sprites/goalkeeper_save_right/gk_save_right_" + e + ".png");
            for (var e = 0; e < NUM_SPRITE_GOALKEEPER[LEFT]; e++) s_oSpriteLibrary.addSprite(SPRITE_NAME_GOALKEEPER[LEFT] + e, "./assets/football/sprites/goalkeeper_save_left/gk_save_left_" + e + ".png");
            for (var e = 0; e < NUM_SPRITE_GOALKEEPER[CENTER_DOWN]; e++) s_oSpriteLibrary.addSprite(SPRITE_NAME_GOALKEEPER[CENTER_DOWN] + e, "./assets/football/sprites/goalkeeper_save_center_down/gk_save_center_down_" + e + ".png");
            for (var e = 0; e < NUM_SPRITE_GOALKEEPER[CENTER_UP]; e++) s_oSpriteLibrary.addSprite(SPRITE_NAME_GOALKEEPER[CENTER_UP] + e, "./assets/football/sprites/goalkeeper_save_center_up/gk_save_center_up_" + e + ".png");
            for (var e = 0; e < NUM_SPRITE_GOALKEEPER[LEFT_DOWN]; e++) s_oSpriteLibrary.addSprite(SPRITE_NAME_GOALKEEPER[LEFT_DOWN] + e, "./assets/football/sprites/goalkeeper_save_down_left/gk_save_down_left_" + e + ".png");
            for (var e = 0; e < NUM_SPRITE_GOALKEEPER[RIGHT_DOWN]; e++) s_oSpriteLibrary.addSprite(SPRITE_NAME_GOALKEEPER[RIGHT_DOWN] + e, "./assets/football/sprites/goalkeeper_save_down_right/gk_save_down_right_" + e + ".png");
        ...
        (this.preloaderReady = function () {
            (DISABLE_SOUND_MOBILE !== !1 && s_bMobile !== !1) || (this._initSounds()), this._loadImages(), (t = !0);/* , (s_oSoundTrack = createjs.Sound.play("soundtrack", { loop: -1 })) */
            $(s_oMain).trigger("game_ready", true);
...
function CMenu() {
    ...
    (this._init = function () {
        ...
        if (
            ((t = { x: CANVAS_WIDTH / 2, y: CANVAS_HEIGHT /2 }),
        ...
        ) 
            {
                ...
                // (e = { x: CANVAS_WIDTH - l.height / 2 - 10, y: l.height / 2 + 10 }), (r = new CToggle(e.x, e.y, l, s_bAudioActive)), r.addEventListener(ON_MOUSE_UP, this._onAudioToggle, this);
            }
...
var CANVAS_WIDTH = 1360,
    ...
    BACK_WALL_GOAL_SIZE = { width: 14.5, depth: 1, height: 7.5 },
    DEFENDER_GOAL_SIZE = { width: 3, depth: 1, height: 6.5 },
    LEFT_RIGHT_WALL_GOAL_SIZE = { width: 0.1, depth: 18, height: 7.5 },
    UP_WALL_GOAL_SIZE = { width: 14.5, depth: 25, height: 0.1 },
    BACK_WALL_GOAL_POSITION = { x: 0, y: 135, z: -2.7 },
    GOAL_LINE_POS = { x: 0, y: BACK_WALL_GOAL_POSITION.y - UP_WALL_GOAL_SIZE.depth -102, z: BACK_WALL_GOAL_POSITION.z },
    POSITION_BALL = { x: 0.05, y: 13.4, z: -9 + BALL_RADIUS },
...
var s_oMenu = null,
    ...
    TEXT_CONGRATULATION = ["GOAL", "GOAL", "GOAL"],
    TEXT_SAVED = "SAVED",
