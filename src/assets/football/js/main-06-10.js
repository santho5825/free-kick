...
function CGame(e, status) {
    ...
    (this._init = function () {
        ...
        (this.onPressUp = function () {
            ...
            if (!y && (r && l && r.x != l.x && r.y != l.y) && !s_oMain.goalScore && IS_PRESSED == 1) { 
    ...
    // }
        ...
        (this.textGoal = function () {
            if (H < TEXT_CONGRATULATION.length) {
                var e = !1;
                var text = ((GK_HIT || GUARD_HIT) || (HIT_ODD === GK_VALUE)) ? TEXT_SAVED : TEXT_CONGRATULATION[H];
                ...
                var e = !1,
                    ...
                    text = ((GK_HIT || GUARD_HIT) || (HIT_ODD === GK_VALUE)) ? TEXT_SAVED : TEXT_CONGRATULATION[n];
                    var scoreVal = (GK_HIT && ROUNDS_NUM > 1) ? GK_ODD: (GUARD_HIT && ROUNDS_NUM >= 3) ? HIT_ODD: HIT_ODD;
                // $(s_oMain).trigger("goal_score", HIT_ODD);
                if(scoreVal < 1){
                    text = TEXT_SAVED;
        ...
        (this.resetScene = function (params) {
            // // // // console.log('resetSccene');
            if (params) {
                // console.log('reset ball', s_oMain.goalScore)
                s_oGame.areaGoal();
            }
            // (b = !1), (w = !1), (L = !1), 
            (R = !1), (N = !1), (x = !1), 
